...
void main()
{
	...
	cout << "¬ведите MAC - адрес: ";
	cin.getline(str, n);
	cout << (is_mac_address(str)==true?"Ёто MAC-адрес!": "Ёто не MAC-адрес!") << endl;
	cout << "¬ведите IP - адрес: ";
	cin.getline(str, n);
	cout << (is_ip_address(str)==true?"Ёто IP-адрес!":"Ёто не IP-адрес!") << endl;
