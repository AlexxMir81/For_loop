...
void main()
{
	...
	cout << ((is_palindrome(str)==true)?"İòî ïàëèíäğîì":"İòî íå ïàëèíäğîì") << endl;;

	cout << "Ââåäèòå ÷èñëî: "; cin >> str;
	cout << ((is_integer(str)==true)?"İòî öåëîå ÷èñëî":"İòî íå öåëîå ÷èñëî") << endl;;
	cout << ((is_bin(str)==true)?"İòî äâîè÷íîå ÷èñëî":"İòî íå äâîè÷íîå ÷èñëî") << endl;;
	cout << ((is_hex(str)==true)?"İòî øåñòíàäöàòåğè÷íîå ÷èñëî":"İòî íå øåñòíàäöàòåğè÷íîå ÷èñëî") << endl;;

	cout << "Ââåäèòå äâîè÷èíîå ÷èñëî: "; cin >> str;
	cout << bin2dec(str) << endl;
	
	cout << "Ââåäèòå hex-÷èñëî: "; cin >> str;
	cout << hex2dec(str) << endl;

	int dec;
	cout << "Êîíâåğò â bin, ââåäèòå dec-÷èñëî, : "; cin >> dec;
	dec2bin(dec);
	cout << "Êîíâåğò â hex, ââåäèòå dec-÷èñëî: "; cin >> dec;
	dec2hex(dec);
...
{
	const int n = 60;
	char lower[n]="abcdefghijklmnopqrstuvwxyzàáâãäå¸æçèéêëìíîïğñòóôõö÷øùúûüışÿ";
	char upper[n]="ABCDEFGHIJKLMNOPQRSTUVWXYZÀÁÂÃÄÅ¨ÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞß";
